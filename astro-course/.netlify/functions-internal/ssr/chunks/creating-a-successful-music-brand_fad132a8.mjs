const id = "creating-a-successful-music-brand.md";
						...
						new Proxy({"src":"/_astro/record.fe8d1997.jpg","width":3000,"height":2000,"format":"jpg"}, {
					...
					,title:"Creating a successful music brand",description:"Tips and strategies for building a strong brand identity as a musician or music business."};
						const _internal = {
							type: 'content',
							filePath: "/Users/alessandro-giuzio/Documents/Ale/GitHub-Repo/astro-course/astro-course/src/content/posts/creating-a-successful-music-brand.md",
