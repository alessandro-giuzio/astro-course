const id = "gear-is-insanely-expensive.md";
						...
						new Proxy({"src":"/_astro/gear.f926c23e.jpg","width":5184,"height":3456,"format":"jpg"}, {
					...
					,title:"Gear is insanely expensive",description:"A discussion of the high costs associated with music equipment and the impact on musicians and the industry as a whole."};
						const _internal = {
							type: 'content',
							filePath: "/Users/alessandro-giuzio/Documents/Ale/GitHub-Repo/astro-course/astro-course/src/content/posts/gear-is-insanely-expensive.md",
