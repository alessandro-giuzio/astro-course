const id = "making-a-home-studio.md";
						...
						new Proxy({"src":"/_astro/studio.4b926210.jpg","width":6720,"height":4480,"format":"jpg"}, {
					...
					,title:"Making a home studio",description:"A beginner's guide to setting up a home recording studio, including equipment recommendations and tips for optimizing your space."};
						const _internal = {
							type: 'content',
							filePath: "/Users/alessandro-giuzio/Documents/Ale/GitHub-Repo/astro-course/astro-course/src/content/posts/making-a-home-studio.md",
