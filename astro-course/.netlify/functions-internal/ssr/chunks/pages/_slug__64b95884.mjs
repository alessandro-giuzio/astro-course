/* empty css                           */import { A as AstroError, l as UnknownContentCollectionError, f as createComponent, n as renderUniqueStylesheet, o as renderScriptElement, p as createHeadAndContent, r as renderTemplate, i as renderComponent, u as unescapeHTML, e as createAstro, m as maybeRenderHead, h as addAttribute, F as Fragment } from '../astro_2f22c4c4.mjs';
import 'clsx';
import { $ as $$Image, a as $$Main, b as $$Layout, g as getImage, c as getThumbnail } from './404_8f375044.mjs';
...
let lookupMap = {};
lookupMap = {"authors":{"type":"content","entries":{"jim-halpert":"/src/content/authors/jim-halpert.md","dwight-schrute":"/src/content/authors/dwight-schrute.md","pam-beesely":"/src/content/authors/pam-beesely.md","michael-scott":"/src/content/authors/michael-scott.md"}},"posts":{"type":"content","entries":{"behind-the-scenes-with-our-artists":"/src/content/posts/behind-the-scenes-with-our-artists.md","collaboration-in-music-production":"/src/content/posts/collaboration-in-music-production.md","creating-a-successful-music-brand":"/src/content/posts/creating-a-successful-music-brand.md","gear-is-insanely-expensive":"/src/content/posts/gear-is-insanely-expensive.md","live-music-is-crucial":"/src/content/posts/live-music-is-crucial.md","guitar-solos-are-still-awesome":"/src/content/posts/guitar-solos-are-still-awesome.md","the-art-of-music-production":"/src/content/posts/the-art-of-music-production.md","tune-your-snare-drum":"/src/content/posts/tune-your-snare-drum.md","making-a-home-studio":"/src/content/posts/making-a-home-studio.md","the-importance-of-audio-quality":"/src/content/posts/the-importance-of-audio-quality.md"}}};
...
const renderEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/authors/dwight-schrute.md": () => import('../dwight-schrute_ea4fab4f.mjs'),"/src/content/authors/jim-halpert.md": () => import('../jim-halpert_6683f830.mjs'),"/src/content/authors/michael-scott.md": () => import('../michael-scott_7f6b0101.mjs'),"/src/content/authors/pam-beesely.md": () => import('../pam-beesely_2b69986b.mjs'),"/src/content/posts/behind-the-scenes-with-our-artists.md": () => import('../behind-the-scenes-with-our-artists_b0c0bbae.mjs'),"/src/content/posts/collaboration-in-music-production.md": () => import('../collaboration-in-music-production_9f8de94c.mjs'),"/src/content/posts/creating-a-successful-music-brand.md": () => import('../creating-a-successful-music-brand_121d65e0.mjs'),"/src/content/posts/gear-is-insanely-expensive.md": () => import('../gear-is-insanely-expensive_7ebbae20.mjs'),"/src/content/posts/guitar-solos-are-still-awesome.md": () => import('../guitar-solos-are-still-awesome_895583c0.mjs'),"/src/content/posts/live-music-is-crucial.md": () => import('../live-music-is-crucial_dab7fdbe.mjs'),"/src/content/posts/making-a-home-studio.md": () => import('../making-a-home-studio_68fd4547.mjs'),"/src/content/posts/the-art-of-music-production.md": () => import('../the-art-of-music-production_173f491d.mjs'),"/src/content/posts/the-importance-of-audio-quality.md": () => import('../the-importance-of-audio-quality_af6f278c.mjs'),"/src/content/posts/tune-your-snare-drum.md": () => import('../tune-your-snare-drum_26e46a42.mjs')});
...
const $$Astro$e = createAstro("https://zippy-semifreddo-79078c.netlify.app");
...
const $$Astro$d = createAstro("https://zippy-semifreddo-79078c.netlify.app");
...
const $$Astro$c = createAstro("https://zippy-semifreddo-79078c.netlify.app");
...
const $$Astro$b = createAstro("https://zippy-semifreddo-79078c.netlify.app");
const $$Post = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$b, $$props, $$slots);
  Astro2.self = $$Post;
  const { post } = Astro2.props;
  const author = await getEntryBySlug("authors", post.data.author);
  return renderTemplate`${maybeRenderHead()}<article> <a${addAttribute(`/blog/${post.slug}`, "href")}> ${renderComponent($$result, "Image", $$Image, { "src": post.data.image, "alt": post.data.title, "width": 600, "height": 600 / 2, "class": "rounded-2xl shadow-xl mb-6 aspect-thumbnail object-cover" })} </a> <a${addAttribute(`/blog/${post.slug}`, "href")} class="text-4xl text-zinc-900 mb-4 font-semibold inline-block"> <h2>${post.data.title}</h2> </a> <p class="text-zinc-500 text-2xl mb-9 line-clamp-2"> ${post.body} </p> <div class="flex justify-between items-center"> ${author ? renderTemplate`<a${addAttribute(`/author/${author?.slug}`, "href")} class="text-zinc-900 text-2xl font-bold"> ${author.data.name} </a>` : renderTemplate`<p class="text-zinc-900 text-2xl font-bold">Unknown</p>`} <span class="text-zinc-700 text-xl"> ${post.data.date} </span> </div> </article>`;
}, "/Users/alessandro-giuzio/Documents/Ale/GitHub-Repo/astro-course/astro-course/src/components/Post.astro", void 0);

const $$Astro$a = createAstro("https://zippy-semifreddo-79078c.netlify.app");
...
const $$Astro$9 = createAstro("https://zippy-semifreddo-79078c.netlify.app");
const $$Pagination = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="flex justify-between"> ${hasPrev ? renderTemplate`<a${addAttribute(`/blog?page=${page - 1}`, "href")} class="bg-teal-900 text-white py-3 px-6 rounded-xl text-xl">
Previous
</a>` : renderTemplate`<div></div>`} ${hasNext ? renderTemplate`<a${addAttribute(`/blog?page=${page + 1}`, "href")} class="bg-teal-900 text-white py-3 px-6 rounded-xl text-xl">
Next
...
const $$Astro$8 = createAstro("https://zippy-semifreddo-79078c.netlify.app");
const $$slug$2 = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Blog - Rhythm Nation", "description": "Read and learn from Music Producers and Enthusiasts" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Main", $$Main, {}, { "default": ($$result3) => renderTemplate` ${maybeRenderHead()}<a href="/blog" class="text-zinc-500 text-2xl mb-16 underline block">← Back to all blogs</a> ${renderComponent($$result3, "H1", $$H1, { "text": "Rhythm Nation Blog" })} <p class="text-zinc-900 text-2xl mb-24 max-sm:mb-14">
Join the Community and learn from Music Producers and Enthusiasts
</p> ${renderComponent($$result3, "CategoryList", $$CategoryList, { "categories": [category], "title": "Posts tagged" })} ${posts.length === 0 ? renderTemplate`<p>No posts where found with that tag</p>` : renderTemplate`<div class="mb-12"> ${renderComponent($$result3, "Pagination", $$Pagination, { "page": page, "numberOfPosts": postsByCategory.length })} </div>${renderComponent($$result3, "PostList", $$PostList, { "posts": posts })}<div class="mt-12"> ${renderComponent($$result3, "Pagination", $$Pagination, { "page": page, "numberOfPosts": postsByCategory.length })} </div>`}` })} ` })}`;
}, "/Users/alessandro-giuzio/Documents/Ale/GitHub-Repo/astro-course/astro-course/src/pages/category/[slug].astro", void 0);

const $$file$2 = "/Users/alessandro-giuzio/Documents/Ale/GitHub-Repo/astro-course/astro-course/src/pages/category/[slug].astro";
...
const $$Astro$7 = createAstro("https://zippy-semifreddo-79078c.netlify.app");
const $$slug$1 = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": author.data.name }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Main", $$Main, {}, { "default": ($$result3) => renderTemplate` ${maybeRenderHead()}<a href="/blog" class="text-zinc-500 text-2xl block mb-16 underline">←Back to all blogs</a> ${renderComponent($$result3, "H1", $$H1, { "text": `Posts by ${author.data.name}` })} <div class="mb-60"> ${renderComponent($$result3, "PostList", $$PostList, { "posts": posts })} </div> ` })} ` })}`;
}, "/Users/alessandro-giuzio/Documents/Ale/GitHub-Repo/astro-course/astro-course/src/pages/author/[slug].astro", void 0);

const $$file$1 = "/Users/alessandro-giuzio/Documents/Ale/GitHub-Repo/astro-course/astro-course/src/pages/author/[slug].astro";
...
const defaultOptions = {
  databaseURL: "https://Alessandro-Giuzio-s-workspace-1fkgss.eu-central-1.xata.sh/db/astro-course"
};
...
const $$TableOfContents = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<nav> <ul> ${headings.map((heading) => {
    return renderTemplate`<li class="text-xl mb-4 text-zinc-500"> <a${addAttribute(`#${heading.slug}`, "href")}>#${heading.text}</a> </li>`;
  })} </ul> </nav>`;
}, "/Users/alessandro-giuzio/Documents/Ale/GitHub-Repo/astro-course/astro-course/src/components/TableOfContents.astro", void 0);
...
const $$Comment = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="flex gap-x-12 items-start"> <span class="text-teal-900 rounded-full border border-teal-900 font-bold text-xl px-5 py-5"> ${initials} </span> <div> <span class="text-zinc-700 font-bold text-xl mr-5"> ${comment.user?.name} </span> <span class="text-zinc-500 text-xl"> ${formattedDate} </span> <p class="text-zinc-500 text-2xl mt-2"> ${comment.text} </p> </div> </div>`;
}, "/Users/alessandro-giuzio/Documents/Ale/GitHub-Repo/astro-course/astro-course/src/components/Comment.astro", void 0);
...
}, "/Users/alessandro-giuzio/Documents/Ale/GitHub-Repo/astro-course/astro-course/src/components/CommentList.astro", void 0);
...
Leave a comment
</label><input type="text" name="comment" id="comment" class="border border-teal-900 rounded-lg text-2xl p-6"></div><button type="submit" class="text-2xl text-zinc-100 bg-teal-900 px-6 py-5 rounded-xl my-1">
Add a comment
</button></form>` : renderTemplate`<p class="text-zinc-700 text-2xl mt-4 mb-24">
Please${""}<a${addAttribute(`/login?redirect=/blog/${post.slug}#comments`, "href")} class="text-teal-900 underline">
login
</a>${""}
to comment
</p>`}`;
}, "/Users/alessandro-giuzio/Documents/Ale/GitHub-Repo/astro-course/astro-course/src/components/CommentForm.astro", void 0);
...
const $$slug = createComponent(async ($$result, $$props, $$slots) => {
  ...
  if (Astro2.request.method === "POST") {
    ...
    if (!user?.value) {
      return Astro2.redirect(`/login?redirect=/blog/${slug}#comments`);
    }
    ...
    return Astro2.redirect(`/blog/${slug}#comments`);
  }
  const post = await getEntryBySlug("posts", slug);
  if (!post) {
    return Astro2.redirect("/404");
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": post.data.title, "image": getThumbnail(post.data.title), "description": post.data.description }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Main", $$Main, {}, { "default": ($$result3) => renderTemplate` ${maybeRenderHead()}<a href="/blog" class="text-zinc-500 text-2xl block mb-16 underline">←Back to all blogs</a> ${renderComponent($$result3, "H1", $$H1, { "text": post.data.title })} ${renderComponent($$result3, "PostMeta", $$PostMeta, { "post": post })} ${renderComponent($$result3, "Image", $$Image, { "src": post.data.image, "alt": post.data.title, "width": 1024, "height": 1024 / 1.5, "class": "rounded-2xl shadow-xl mb-28 aspect-thumbnail object-cover" })} <div class="mb-10"> ${renderComponent($$result3, "TableOfContents", $$TableOfContents, { "headings": headings })} </div> <div class="relative"> ${renderComponent($$result3, "Share", $$Share, { "post": post })} <div class="prose prose-2xl overflow-visible relative"> ${renderComponent($$result3, "Content", Content, {})} </div> </div> ` })} <div class="bg-teal-100/30 py-14 relative border-b border-teal-900 mt-44"> <div id="comments" class="mb-4"> <h2> <span class="font-bold text-teal-900 text-4xl mr-12">Comments</span> <span class="border border-teal-900 text-teal-900 rounded-full px-4 py-2 font-bold text-2xl">${comments.length}</span> </h2> </div> <div class="max-w-7xl mx-auto"> <div class="mb-14"> ${renderComponent($$result2, "CommentForm", $$CommentForm, {})} </div> ${renderComponent($$result2, "CommentList", $$CommentList, { "comments": comments })} </div> </div> ` })}`;
}, "/Users/alessandro-giuzio/Documents/Ale/GitHub-Repo/astro-course/astro-course/src/pages/blog/[slug].astro", void 0);

const $$file = "/Users/alessandro-giuzio/Documents/Ale/GitHub-Repo/astro-course/astro-course/src/pages/blog/[slug].astro";
const $$url = "/blog/[slug]";
