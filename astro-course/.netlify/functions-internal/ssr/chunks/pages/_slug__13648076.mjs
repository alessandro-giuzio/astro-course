/* empty css                           */import { e as createAstro, f as createComponent, r as renderTemplate, i as renderComponent, m as maybeRenderHead, h as addAttribute } from '../astro_4241d5aa.mjs';
import 'clsx';
import { g as getCollection, $ as $$H1, a as $$CategoryList, b as $$Pagination, c as $$PostList, d as getEntryBySlug } from './_page__a2cd2870.mjs';
import { a as $$Main, b as $$Layout, g as getImage, $ as $$Image } from './404_e82d43db.mjs';
...
const $$slug$1 = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Blog - Rhythm Nation", "description": "Read and learn from Music Producers" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Main", $$Main, {}, { "default": ($$result3) => renderTemplate` ${maybeRenderHead()}<a href="/blog" class="text-zinc-500 text-2xl block mb-16 underline">←Back to all blogs</a> ${renderComponent($$result3, "H1", $$H1, { "text": "Alessandro Giuzio Blog" })} <p class="text-zinc-900 text-2xl mb-24 max-sm:mb-14">
Lorem, ipsum dolor sit amet consectetur adipisicing elit. Aliquid, magnam!
</p> ${renderComponent($$result3, "CategoryList", $$CategoryList, { "categories": [category], "title": "Posts Tagged" })} <div class="mb-12"> ${renderComponent($$result3, "Pagination", $$Pagination, { "nextURL": "/blog/2" })} </div> ${renderComponent($$result3, "PostList", $$PostList, { "posts": posts })} <div class="mb-36"> ${renderComponent($$result3, "Pagination", $$Pagination, { "nextURL": "/blog/2" })} </div> ` })} ` })}`;
