...
/* empty css                           */import { e as createAstro, f as createComponent, A as AstroError, g as ImageMissingAlt, r as renderTemplate, m as maybeRenderHead, h as addAttribute, s as spreadAttributes, i as renderComponent, j as renderHead, k as renderSlot } from '../astro_4241d5aa.mjs';
import 'clsx';
/* empty css                          */import { i as isESMImportedImage, g as getImage$1 } from '../astro/assets-service_51447d2b.mjs';
...
const $$Header = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Header;
  return renderTemplate`${maybeRenderHead()}<header class="w-full mx-auto px-24 py-12 max-sm:px-5 max-sm:py-10 max-w-7xl"> <a href="/" class="flex items-center gap-x-4"> ${renderComponent($$result, "Image", $$Image, { "src": heartbeat, "class": "w-16", "alt": "Logo", "width": 64, "height": 64 })} <p class="uppercase text-3xl text-zinc-900">Blog</p> </a> </header>`;
...
export { $$Image as $, _404 as _, $$Main as a, $$Layout as b, getImage as g, imageConfig as i };
