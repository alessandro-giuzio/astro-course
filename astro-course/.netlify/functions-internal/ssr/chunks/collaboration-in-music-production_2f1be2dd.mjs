const id = "collaboration-in-music-production.md";
					...
					,title:"Collaboration in music production",description:"An examination of the benefits and challenges of working with other musicians and producers in the music-making process."};
						const _internal = {
							type: 'content',
							filePath: "/Users/alessandro-giuzio/Documents/Ale/GitHub-Repo/astro-course/astro-course/src/content/posts/collaboration-in-music-production.md",
